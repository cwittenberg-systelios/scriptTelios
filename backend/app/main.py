...
from app.api import health, style_embeddings, jobs, admin, testrun, recordings, workflow_manifest, selfcheck, feedback, activity, ism, interview, sns
...
app.include_router(interview.router,         prefix="/api", tags=["Interview"])  # v19.23
app.include_router(sns.router,               prefix="/api", tags=["SNS"])  # v19.41
